...
import java.util.*;
import static hackerrank30days.SolutionDay27.minimum_index;
...
public class Day27Testing {
    ...
    {
        int val = TestDataExactlyTwoDifferentMinimums.get_expected_result();
        if(val<=0)
        {
            throw new AssertionError("result is not an Integer");
        }
        return val;
    }
